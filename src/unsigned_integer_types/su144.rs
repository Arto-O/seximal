...
impl Su144 {
    ...
    /// # Panics
    ///
    /// Panics if the underlying `u64` value overflows when converting to `usize`. Applicable only on 32-bit systems.
    ...
    /// # Panics
    ///
    /// Panics if the underlying `u64` value overflows when converting to `isize`.
